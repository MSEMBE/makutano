...
<div class="mk-hero" style="position:relative;padding:88px 46px 64px;max-width:880px">
  ...
  <div style="display:flex;gap:14px;align-items:center">
    ...
    <a href="about.php" style="padding:16px 28px;border:1.5px solid rgba(255,255,255,.35);border-radius:999px;font:500 14.5px 'Space Grotesk',sans-serif;color:#fff"><span class="lang-en">View company profile</span><span class="lang-sw">Wasifu wa kampuni</span></a>
  </div>
</div>
