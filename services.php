...
<div class="mk-pad" style="position:relative;padding:74px 46px 56px;max-width:900px">
  ...
  <h1 style="margin:0 0 22px;font:700 60px/1.02 'Space Grotesk',sans-serif;letter-spacing:-.03em;text-wrap:balance"><span class="lang-en">Expertise &amp; core competencies</span><span class="lang-sw">Utaalam na uwezo wetu wa msingi</span></h1>
